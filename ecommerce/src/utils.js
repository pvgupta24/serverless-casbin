...
// ================================================================== //
// Helper Functions
module.exports._getConfig = fileName => __dirname + '/config/' + fileName;
module.exports._printDebug = variable => console.log('DEBUG: Variable', variable, 'of type', typeof (variable));
module.exports._printFunctionStage =
...
module.exports.triggerNextFunction = (message, callback, currFunction, response = null) => {
  _printDebug(message);
